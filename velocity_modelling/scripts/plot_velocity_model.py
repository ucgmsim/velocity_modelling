...
def plot_realisation_file(
    ...
    realisation_ffp : Path
        Path to the realisation file containing velocity model parameters.
    ...
    domain_parameters = realisations.DomainParameters.read_from_realisation(
        realisation_ffp
    )
    ...
    if velocity_model_ffp:
        velocity_model = load_velocity_model_file(
            velocity_model_ffp,
            component,
            domain_parameters.nx,
            domain_parameters.ny,
            domain_parameters.nz,
        )
        plot_velocity_model(
            fig,
            box,
